...
// JournalPageView.tsx exactly, relabeled for Blog. Independent component —
// not a wrapper around JournalPageView/StoriesPageView.
  ...
  return (
    <div className="p-6 space-y-5 overflow-y-auto">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-bold text-[var(--text-primary)]">Blog</h1>
          <p className="font-body text-sm text-[var(--text-muted)] mt-0.5">
            {meta ? `${meta.total} posts` : 'Manage blog posts'}
          </p>
        </div>
      ...
      <div className="cms-card overflow-hidden">
        <DataTable
          ...
          emptyDescription="Start writing to build your blog"
          emptyIcon={<Newspaper />}
          bulkActions={[
