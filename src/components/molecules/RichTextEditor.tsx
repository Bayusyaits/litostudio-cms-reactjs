  ...
  useEffect(() => {
    ...
    import('@ckeditor/ckeditor5-build-classic').then((mod) => {
      ...
      ClassicEditor.create(containerRef.current!, {
        ...
        toolbar: {
          items: [
            // Only features rendered on the website via SafeHtml.vue.
            // Removed: heading (H2-H4), strikethrough, link, blockQuote,
            //          bulletedList, numberedList, insertTable — these tags
            //          are stripped by SafeHtml ALLOWED_TAGS on the website.
        ...
        // Restrict alignment to what SafeHtml allows via inline style
        alignment: {
