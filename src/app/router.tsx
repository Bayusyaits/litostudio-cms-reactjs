...
const ComingSoonPage    = lazy(() => import('@/modules/coming-soon/ComingSoonPage'))
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      // Stub routes for modules not yet built
      { path: 'campaigns',  element: <S><ComingSoonPage /></S> },
      { path: 'seo',        element: <S><ComingSoonPage /></S> },
